import{r as e}from"./rolldown-runtime-hePW80VL.js";import{c as t,d as n,u as r}from"./motion-D4psEU6N.js";import{M as i}from"./vendor-CiaQW6Ys.js";import{d as a,i as o,l as s,n as c,s as l}from"./index-DItDMkqX.js";import{n as u,r as d,t as f}from"./Section-C-MMQqwP.js";import{t as p}from"./SpotlightCard-DCbALarI.js";import{t as m}from"./Modal-DswTFBbh.js";var h=`# ---------------------------------------------------------------------------
...
items:
  ...
  - title: Pipeline de MLOps en AWS
    ...
    skills: [SageMaker, Step Functions, Terraform, CI/CD, Model Registry]
`,_=e(n(),1),v=r();function y({project:e,proposalLabel:t,detailsLabel:n,levelLabel:r,level:i,onOpen:a}){let c=o(e.image),l=(0,_.useRef)(null),u=(0,_.useCallback)(e=>{l.current=e.clientX},[]),d=(0,_.useCallback)(e=>{let t=l.current;l.current=null,!(t!==null&&Math.abs(e.clientX-t)>8)&&a()},[a]);return(0,v.jsxs)(p,{lift:!1,className:`flex h-full flex-col overflow-hidden`,children:[(0,v.jsx)(`button`,{type:`button`,onPointerDown:u,onClick:d,className:`absolute inset-0 z-0 rounded-2xl`,children:(0,v.jsx)(`span`,{className:`sr-only`,children:`${n}: ${e.title}`})}),(0,v.jsxs)(`div`,{className:`pointer-events-none relative z-[1] flex flex-1 flex-col`,children:[(0,v.jsxs)(`div`,{className:`relative aspect-video overflow-hidden border-b border-line bg-canvas-deep`,children:[c?(0,v.jsx)(`img`,{src:c,alt:``,loading:`lazy`,decoding:`async`,draggable:`false`,className:`h-full w-full object-cover transition-transform duration-500 ease-out select-none group-hover:scale-[1.04]`}):(0,v.jsx)(`div`,{className:`grid h-full w-full place-items-center px-6 text-center`,children:(0,v.jsx)(`span`,{className:`font-mono text-xs tracking-widest text-ink-subtle uppercase`,children:e.title})}),i?(0,v.jsxs)(`span`,{className:`absolute top-3 left-3 rounded-full border border-line-accent bg-accent/15 px-2.5 py-1 font-mono text-[0.625rem] tracking-widest text-accent uppercase backdrop-blur-md`,children:[r,` `,i.id,` · `,i.name]}):null,e.placeholder?(0,v.jsx)(`span`,{className:`absolute top-3 right-3 rounded-full border border-line bg-canvas-base/80 px-2.5 py-1 font-mono text-[0.625rem] tracking-widest text-ink uppercase backdrop-blur-md`,children:t}):null]}),(0,v.jsxs)(`div`,{className:`flex flex-1 flex-col gap-3 p-6`,children:[(0,v.jsx)(`h3`,{className:`text-lg font-semibold tracking-tight text-balance text-ink`,children:e.title}),(0,v.jsx)(`p`,{className:`line-clamp-3 flex-1 text-sm leading-relaxed text-ink-muted`,children:e.summary}),e.skills?.length?(0,v.jsxs)(`ul`,{className:`flex flex-wrap gap-1.5 pt-1`,children:[e.skills.slice(0,4).map(e=>(0,v.jsx)(`li`,{className:`rounded-full border border-line bg-surface px-2.5 py-1 font-mono text-[0.6875rem] text-ink-subtle transition-colors duration-200 group-hover:border-line-accent group-hover:text-ink`,children:e},e)),e.skills.length>4?(0,v.jsxs)(`li`,{className:`px-1 py-1 font-mono text-[0.6875rem] text-ink-subtle`,children:[`+`,e.skills.length-4]}):null]}):null,(0,v.jsxs)(`span`,{className:`mt-1 inline-flex w-fit items-center gap-1.5 text-sm font-medium text-accent underline decoration-transparent underline-offset-4 transition-all duration-200 group-hover:text-accent-bright group-hover:decoration-current`,children:[n,(0,v.jsx)(s.arrowUpRight,{"aria-hidden":`true`,className:`h-4 w-4 rotate-45 transition-transform duration-200 group-hover:translate-x-0.5`})]})]})]})]})}function b({hacia:e,deshabilitado:n,etiqueta:r,onClick:i}){return(0,v.jsx)(t.button,{type:`button`,onClick:i,disabled:n,"aria-label":r,whileHover:n?void 0:{scale:1.06,y:-2},whileTap:n?void 0:{scale:.94},transition:{duration:.2,ease:a},className:`grid h-11 w-11 place-items-center rounded-full border border-line bg-surface text-ink shadow-inner-top transition-colors duration-200 hover:border-line-accent hover:bg-surface-hover disabled:pointer-events-none disabled:opacity-35`,children:(0,v.jsx)(s.arrowUpRight,{"aria-hidden":`true`,className:`h-4 w-4 ${e<0?`-rotate-[135deg]`:`rotate-45`}`})})}function x({items:e,proposalLabel:t,detailsLabel:n,levelLabel:r,levels:a,onOpen:o}){let{t:s}=i(),c=(0,_.useRef)(null),[l,u]=(0,_.useState)(0),[d,f]=(0,_.useState)({inicio:!0,fin:!1}),p=(0,_.useCallback)(()=>{let e=c.current;if(!e)return 0;let t=e.getBoundingClientRect().left+1,n=0,r=1/0;return Array.from(e.children).forEach((e,i)=>{let a=Math.abs(e.getBoundingClientRect().left-t);a<r&&(r=a,n=i)}),n},[]),m=(0,_.useCallback)(()=>{let e=c.current;if(!e)return;let t=e.scrollLeft+e.clientWidth>=e.scrollWidth-8;u(t?e.children.length-1:p()),f({inicio:e.scrollLeft<=8,fin:t})},[p]);(0,_.useEffect)(()=>{let e=c.current;if(e)return m(),e.addEventListener(`scroll`,m,{passive:!0}),window.addEventListener(`resize`,m),()=>{e.removeEventListener(`scroll`,m),window.removeEventListener(`resize`,m)}},[m,e.length]);let h=(0,_.useCallback)(e=>{let t=c.current;if(!t)return;let n=t.children[Math.max(0,Math.min(e,t.children.length-1))];if(!n)return;let r=parseFloat(getComputedStyle(t).paddingLeft)||0;t.scrollLeft=n.offsetLeft-t.offsetLeft-r},[]),g=(0,_.useCallback)(e=>h(p()+e),[h,p]),x=(0,_.useCallback)(e=>{e.key===`ArrowRight`?(e.preventDefault(),g(1)):e.key===`ArrowLeft`&&(e.preventDefault(),g(-1))},[g]);return(0,v.jsxs)(`div`,{className:`flex flex-col gap-6`,children:[(0,v.jsx)(`ul`,{ref:c,tabIndex:0,onKeyDown:x,"aria-label":s(`actions.carousel`),className:`nc-carousel -mx-5 flex snap-x snap-proximity gap-4 overflow-x-auto px-5 pb-2 md:-mx-8 md:px-8`,children:e.map((i,s)=>(0,v.jsx)(`li`,{"aria-label":`${s+1} / ${e.length}`,className:`w-[82%] shrink-0 snap-start sm:w-[58%] lg:w-[calc((100%-2rem)/3)]`,children:(0,v.jsx)(y,{project:i,proposalLabel:t,detailsLabel:n,levelLabel:r,level:a.find(e=>e.id===i.level),onOpen:()=>o(s)})},i.title))}),(0,v.jsxs)(`div`,{className:`flex items-center justify-between gap-4`,children:[(0,v.jsx)(`ul`,{className:`flex items-center gap-2`,children:e.map((t,n)=>(0,v.jsx)(`li`,{children:(0,v.jsx)(`button`,{type:`button`,onClick:()=>h(n),"aria-label":`${n+1} / ${e.length}`,"aria-current":n===l?`true`:void 0,className:`h-1.5 rounded-full transition-all duration-300 ${n===l?`w-7 bg-accent`:`w-1.5 bg-line-hover hover:bg-ink-subtle`}`})},t.title))}),(0,v.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,v.jsx)(b,{hacia:-1,deshabilitado:d.inicio,etiqueta:s(`actions.previous`),onClick:()=>g(-1)}),(0,v.jsx)(b,{hacia:1,deshabilitado:d.fin,etiqueta:s(`actions.next`),onClick:()=>g(1)})]})]})]})}function S({project:e,level:t,levelLabel:n,open:r,onClose:i,proposalLabel:a,defaultLinkLabel:c}){let l=o(e?.image);return(0,v.jsx)(m,{open:r,onClose:i,titleId:`proyecto-titulo`,children:e?(0,v.jsxs)(`div`,{className:`flex flex-col`,children:[l?(0,v.jsxs)(`div`,{className:`relative aspect-video shrink-0 overflow-hidden border-b border-line bg-canvas-deep`,children:[(0,v.jsx)(`img`,{src:l,alt:``,className:`h-full w-full object-cover`,decoding:`async`}),e.placeholder?(0,v.jsx)(`span`,{className:`absolute top-4 left-4 rounded-full border border-line bg-canvas-base/80 px-2.5 py-1 font-mono text-[0.625rem] tracking-widest text-ink uppercase backdrop-blur-md`,children:a}):null]}):null,(0,v.jsxs)(`div`,{className:`flex flex-col gap-5 p-6 sm:p-8`,children:[t?(0,v.jsxs)(`span`,{className:`nc-eyebrow`,children:[n,` `,t.id,` · `,t.name,` — `,t.note]}):null,(0,v.jsx)(`h3`,{id:`proyecto-titulo`,className:`text-2xl font-semibold tracking-tight text-balance text-ink`,children:e.title}),(0,v.jsx)(`p`,{className:`text-base leading-relaxed text-ink-muted`,children:e.summary}),e.skills?.length?(0,v.jsxs)(`div`,{className:`flex flex-col gap-2.5`,children:[(0,v.jsx)(`span`,{className:`nc-eyebrow`,children:e.skillsLabel}),(0,v.jsx)(`ul`,{className:`flex flex-wrap gap-1.5`,children:e.skills.map(e=>(0,v.jsx)(`li`,{className:`rounded-full border border-line bg-surface px-2.5 py-1 font-mono text-[0.6875rem] text-ink-subtle`,children:e},e))})]}):null,e.url?(0,v.jsxs)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer noopener`,className:`inline-flex w-fit items-center gap-1.5 text-sm font-medium text-accent transition-colors duration-200 hover:text-accent-bright`,children:[e.linkLabel||c,(0,v.jsx)(s.arrowUpRight,{"aria-hidden":`true`,className:`h-4 w-4`})]}):null]})]}):null})}var C=Object.assign({"./content.en.yaml":h,"./content.es.yaml":g});function w(){let e=c(),t=(0,_.useMemo)(()=>l(C,e)??{},[e]),n=t.items??[],[r,i]=(0,_.useState)(null);return n.length===0?null:(0,v.jsxs)(f,{id:`lab`,children:[(0,v.jsx)(u,{eyebrow:t.eyebrow,title:t.title,lead:t.lead}),(0,v.jsx)(d,{className:`mt-12 lg:mt-16`,children:(0,v.jsx)(x,{items:n,proposalLabel:t.proposalLabel,detailsLabel:t.detailsLabel,levelLabel:t.levelLabel,levels:t.levels??[],onOpen:i})}),(0,v.jsx)(S,{project:r===null?null:{...n[r],skillsLabel:t.skillsLabel},level:r===null?null:(t.levels??[]).find(e=>e.id===n[r].level),levelLabel:t.levelLabel,open:r!==null,onClose:()=>i(null),proposalLabel:t.proposalLabel,defaultLinkLabel:t.defaultLinkLabel})]})}export{w as default};