import{r as e}from"./rolldown-runtime-hePW80VL.js";import{d as t,u as n}from"./motion-D4psEU6N.js";import{M as r}from"./vendor-mU39PI2O.js";import{c as i,n as a,o,p as s,t as c}from"./index-BpTj6lcw.js";import{n as l,r as u,t as d}from"./Section-DDC2HU0q.js";import{t as f}from"./SpotlightCard-WcGzUkJk.js";var p=`# ---------------------------------------------------------------------------\r
...
#   url      → public link; leave empty when the project is not public\r
# ---------------------------------------------------------------------------\r
\r
...
#   url      → enlace público; déjalo vacío si el proyecto no es público\r
# ---------------------------------------------------------------------------\r
\r
...
\r
  - id: booklick\r
    ...
    tags: [Python, TypeScript, PostgreSQL, Elastic Search, AWS, Power BI]\r
`,h=e(t(),1),g=n(),_={hero:`md:col-span-6 lg:col-span-4 lg:row-span-2`,tall:`md:col-span-6 lg:col-span-2 lg:row-span-2`,wide:`md:col-span-3 lg:col-span-3`};function v({project:e,index:t=0}){let{t:n}=r(),a=i[e.icon]??i.layers,o=e.size===`hero`,l=!!e.url;return(0,g.jsx)(u,{as:`article`,variants:s,delay:t*.08,className:`${_[e.size]??_.wide} min-w-0`,children:(0,g.jsxs)(f,{className:`flex h-full flex-col gap-4 p-6 md:p-7`,children:[(0,g.jsxs)(`header`,{className:`flex items-start justify-between gap-4`,children:[(0,g.jsxs)(`div`,{className:`flex min-w-0 flex-col gap-2`,children:[(0,g.jsx)(`span`,{className:`nc-eyebrow`,children:e.kicker}),(0,g.jsx)(`h3`,{className:`font-semibold tracking-tight text-balance text-ink ${o?`text-2xl md:text-3xl`:`text-xl`}`,children:e.title})]}),(0,g.jsx)(`span`,{className:`grid h-11 w-11 shrink-0 place-items-center rounded-xl border border-line bg-surface text-accent shadow-inner-top transition-colors duration-200 group-hover:border-line-accent`,children:(0,g.jsx)(a,{"aria-hidden":`true`,className:`h-5 w-5`})})]}),(0,g.jsx)(`p`,{className:`font-mono text-[0.6875rem] tracking-widest text-ink-subtle uppercase`,children:e.period}),(0,g.jsx)(c,{className:`gap-3`,children:e.summary??``}),e.metrics?.length?(0,g.jsx)(`dl`,{className:`mt-auto flex flex-wrap gap-3 pt-2`,children:e.metrics.map(e=>(0,g.jsxs)(`div`,{className:`min-w-0 flex-1 rounded-xl border border-line bg-surface px-4 py-3 shadow-inner-top`,children:[(0,g.jsx)(`dt`,{className:`text-[0.6875rem] tracking-wide text-ink-subtle`,children:e.label}),(0,g.jsx)(`dd`,{className:`font-mono text-lg font-semibold tracking-tight text-ink`,children:e.value})]},e.label))}):null,e.tags?.length?(0,g.jsx)(`ul`,{className:`flex flex-wrap gap-1.5 ${e.metrics?.length?``:`mt-auto pt-2`}`,children:e.tags.map(e=>(0,g.jsx)(`li`,{className:`rounded-full border border-line bg-surface px-2.5 py-1 font-mono text-[0.6875rem] text-ink-subtle transition-colors duration-200 group-hover:border-line-accent group-hover:text-ink`,children:e},e))}):null,l?(0,g.jsxs)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer noopener`,className:`inline-flex w-fit items-center gap-1.5 text-sm font-medium text-accent transition-colors duration-200 hover:text-accent-bright`,children:[n(`actions.viewProject`),(0,g.jsx)(i.arrowUpRight,{"aria-hidden":`true`,className:`h-4 w-4`})]}):null]})})}var y=Object.assign({"./content.en.yaml":p,"./content.es.yaml":m});function b(){let e=a(),t=(0,h.useMemo)(()=>o(y,e)??{},[e]),n=t.items??[];return(0,g.jsxs)(d,{id:`projects`,children:[(0,g.jsx)(l,{eyebrow:t.eyebrow,title:t.title,lead:t.lead}),(0,g.jsx)(`div`,{className:`mt-12 grid auto-rows-min grid-cols-1 gap-4 md:grid-cols-6 lg:mt-16 lg:auto-rows-[minmax(11.25rem,auto)]`,children:n.map((e,t)=>(0,g.jsx)(v,{project:e,index:t},e.id??e.title))})]})}export{b as default};